...
const startGame = () => {
  ...
  gameId = 0
    ...
    document.querySelector('#game').style.padding = '10px 0% 200px'
    document.querySelector('#game-intro').style.padding = '10px 0% 200px'
